...
class Task(models.Model):
    ...
    labels = models.ManyToManyField(Label, blank=True, through='RelationModel', through_fields=('task', 'label'), related_name='labels', verbose_name=_('Labels') )
	
    created_at = models.DateTimeField(auto_now_add=True, verbose_name=_('Created at'))
    author = models.ForeignKey(CustomUser, on_delete=models.PROTECT, blank=False, related_name='author', verbose_name=_('Author'))
